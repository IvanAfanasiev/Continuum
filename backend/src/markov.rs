...
static AMBIENT_PRESET: MarkovPreset = MarkovPreset {
    ...
    layers: &[
        LayerConfig {
            ...
            note_max: 79,
            vel_scale: 0.10,
            envelope: Some(EnvelopeConfig::new(1450.0, 900.0, 0.28, 1800.0)),
        },
        LayerConfig {
            ...
            note_max: 87,
            vel_scale: 0.13,
            envelope: Some(EnvelopeConfig::new(90.0, 1050.0, 0.06, 2600.0)),
        },
        LayerConfig {
            ...
            note_max: 50,
            vel_scale: 0.24,
            envelope: Some(EnvelopeConfig::new(24.0, 520.0, 0.26, 980.0)),
        },
        LayerConfig {
            ...
            note_max: 103,
            vel_scale: 0.09,
            envelope: Some(EnvelopeConfig::new(1.0, 1250.0, 0.0, 2200.0)),
        },
    ],
};
